...
DISALLOWED_GOAL_WINDOW_SECONDS: float = _env_float("DISALLOWED_GOAL_WINDOW_SECONDS", 120.0)
LLM_AGGREGATION_ENABLED: bool = os.environ.get("LLM_AGGREGATION_ENABLED", "1").lower() in ("1", "true", "yes")
